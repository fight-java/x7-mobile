...
var base = angular.module("base", ['pascalprecht.translate']);
/**
...
.service('baseService', ['$http','$q','$jsonToFormData','$translate', function($http,$q,$jsonToFormData,$translate) {
	...
	$http.defaults.headers.common.Authorization = HtUtil.getLocalAuth();
	
	$translate.use("i18n-zh-CN");
...
.config(['$httpProvider', function($httpProvider) {
	$httpProvider.defaults.headers.common["Authorization"] = localStorage.getItem('authorization');
